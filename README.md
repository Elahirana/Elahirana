...
<!---
Elahirana/Elahirana is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
You can click #Elahirana/README.md
#Jangan Recode asw
...
print '\x1b[1;96m   *Elahirana/README.md*   \    /   '
print '\x1b[1;96m  \ Crack Facebook\  \  /    '
print '\x1b[1;96m  /Creator:\Elahirana/README.md2/     ' 
...
def login():
    os.system('clear')
    os.system("figlet |Elahirana/README.mdlolcat")
    try:
...
def menu():
    ...
    try:
        ...
        try:
            ...
            keluar()
    os.system('clear')
    os.system(" figlet Elahirana/README.md|lolcat") 
    print '\x1b[1;96m                   /\  /--\  '                
    print '\x1b[1;96m           _______/  \/    1 '
    print '\x1b[1;96m  /\       /____            1'
    print '\x1b[1;96m  1-------/ /__|    O  /    1'
    ...
    print '\x1b[1;96m   *Elahirana/README.md*   \    /   '
    print '\x1b[1;96m  \ Crack Facebook\  \  /    '
    print '\x1b[1;96m  /Creator:\Elahirana/README.md/     ' 
    print logo
...
def pilih():
    zedd = raw_input('\x1b[1;96mroot@ 'Elahirana/README.md)
    if zedd == '':
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/Elahirana/README.m)
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
# okay decompiling 3.pyc
 Preview link to take a look at 
